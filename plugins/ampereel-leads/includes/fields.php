...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'ampereel-leads' ),
				'storm'       => __( 'Storm or hail damage', 'ampereel-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'ampereel-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'ampereel-leads' ),
				'not-sure'    => __( 'Vet inte än', 'ampereel-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'ampereel-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'ampereel-leads' ),
				'research' => __( 'Jag kollar bara priser', 'ampereel-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'ampereel-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'ampereel-leads' ),
		'contacted' => __( 'Kontaktad', 'ampereel-leads' ),
		'quoted'    => __( 'Quote sent', 'ampereel-leads' ),
		'won'       => __( 'Won', 'ampereel-leads' ),
		'lost'      => __( 'Lost', 'ampereel-leads' ),
		'spam'      => __( 'Misstänkt spam', 'ampereel-leads' ),
	);
}
